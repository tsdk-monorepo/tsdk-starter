...
var path_params_1 = require("./path-params");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!axiosInstance) {
                        throw new error_1.NoHandlerError("Call `setAxiosInstance` first");
                    }
                    path = apiConfig.path, headers = apiConfig.headers;
                    method = apiConfig.method.toLowerCase();
                    payload = __assign({ method: method === 'patch' ? method.toUpperCase() : method, url: path }, requestConfig);
                    if (headers) {
                    ...
                    if (requestData) {
                        ...
                        if ((0, tsdk_helper_1.checkMethodHasBody)(method)) {
                            payload.data = data_1;
                            if (requestConfig === null || requestConfig === void 0 ? void 0 : requestConfig.params) {
                                payload.params = requestConfig.params;
                            }
                        }
                        else {
                            payload.params = (requestConfig === null || requestConfig === void 0 ? void 0 : requestConfig.params) ? __assign(__assign({}, requestConfig.params), data_1) : data_1;
                        }
                    }
                    if (requestData && apiConfig.paramsInUrl) {
                        payload.url = (0, path_params_1.pathParams)(path, requestData, apiConfig.paramsInUrl);
                    }
